...
3. Name it something like `faceoff-cysa`. Click **Continue**.
...
5. You'll land on a screen showing a URL like
   `https://faceoff-cysa-default-rtdb.firebaseio.com/` — that's your `databaseURL`.
...
3. App nickname: `faceoff-cysa`. **Do not** check "Firebase Hosting". Click **Register app**.
...
const firebaseConfig = {
  ...
  authDomain: "faceoff-cysa.firebaseapp.com",
  databaseURL: "https://faceoff-cysa-default-rtdb.firebaseio.com",
  projectId: "faceoff-cysa",
  storageBucket: "faceoff-cysa.appspot.com",
