/* =====================================================================
   ...
   game writes to its own namespace (this one uses rooms/cysa-XXXX),
   so a CySA room code can never collide with a Core 2 room code.
   ===================================================================== */
